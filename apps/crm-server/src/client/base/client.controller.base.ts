...
import { RdpDetailFindManyArgs } from "../../rdpDetail/base/RdpDetailFindManyArgs";
...
export class ClientControllerBase {
  ...
  async findRdpDetails(
    @common.Req() request: Request,
    @common.Param() params: ClientWhereUniqueInput
  ): Promise<RdpDetail[]> {
    const query = plainToClass(RdpDetailFindManyArgs, request.query);
    const results = await this.service.findRdpDetails(params.id, {
      ...query,
      select: {
        client: {
          select: {
  ...
  @common.Post("/:id/rdpDetails")
  @nestAccessControl.UseRoles({
    resource: "Client",
    action: "update",
    possession: "any",
  })
  async connectRdpDetails(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: RdpDetailWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      rdpDetails: {
        connect: body,
  ...
  @common.Patch("/:id/rdpDetails")
  @nestAccessControl.UseRoles({
    resource: "Client",
    action: "update",
    possession: "any",
  })
  async updateRdpDetails(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: RdpDetailWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/rdpDetails")
  @nestAccessControl.UseRoles({
    resource: "Client",
    action: "update",
    possession: "any",
  })
  async disconnectRdpDetails(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: RdpDetailWhereUniqueInput[]
  ): Promise<void> {
    const data = {
